...
public protocol IJobsApiService {
...
open class JobsApiService: IJobsApiService {
    
    
    public func getJobs(description: String, page: Int?, completion: @escaping ((_ data: [Job]?, _ error: Error?) -> Void)) {
    ...
    public func getCurrentJob(id: String, completion: @escaping ((_ data: Job?,_ error: Error?) -> Void)) {
